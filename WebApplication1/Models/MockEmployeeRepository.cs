...
namespace WebApplication1.Models
{
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        {
            return this._employeeList.Where(x => x.Id == id).FirstOrDefault();
        }
        ...
        {
           Employee employee= this._employeeList.FirstOrDefault(x=>x.Id==id);
            if(employee!=null)
            {
        ...
        {
            Employee employee = this._employeeList.FirstOrDefault(x => x.Id == employeeChanges.Id);
            if (employee != null)
            {
